...
enum { DATA_FRAME_EVENT_EAPOLKEY_FRAME, DATA_FRAME_EVENT_PMKID };
 ...
 */
typedef enum { SEARCH_HANDSHAKE, SEARCH_PMKID } search_type_t;
 ...
 */
void frame_analyzer_capture_start(search_type_t search_type,
                                  const uint8_t *bssid);
