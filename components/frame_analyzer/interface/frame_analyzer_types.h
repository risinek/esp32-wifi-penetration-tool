 ...
 *
 * @brief Provides structures and constants based on various standards like
 * 802.11, 802.1X etc...
 */
...
/**
 * @todo MIC lenght is dependent on 802.11-2016 [12.7.3] -
 * key_infromation_t.descrptor_version
 * @see Ref: 802.11-2016 [12.7.2]
 */
...
/**
 * @note Needs trailing byte due to casting to uint32_t and converting from
 * netlong
 * @see Ref: 802.11-2016 [12.7.2, Table 12-6]
 */
