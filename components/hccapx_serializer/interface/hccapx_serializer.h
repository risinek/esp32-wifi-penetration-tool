 ...
 *
 * @brief Provides interface to generate HCCAPX formatted binary from raw frame
 * bytes
 */
 ...
 *
 * This will clear any previous HCCAPX. If you want to save it, first call
 * hccapx_serializer_get() and copy buffer somewhere else.
 ...
 * If frame contains handshake from another STA than the one that was already
 * added before, frame will be skipped and error message will be printed.
 *
