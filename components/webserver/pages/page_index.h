...
"<body onLoad=\"getStatus()\">\n"
    ...
    "var defaultAttackMethods = document.getElementById(\"attack_method\").innerHTML;\n"
    "function getStatus() {\n"
    ...
    "function updateConfigurableFields(el){\n"
        "document.getElementById(\"attack_method\").innerHTML = defaultAttackMethods;\n"
        "document.getElementById(\"attack_method\").setAttribute(\"disabled\", \"true\");\n"
