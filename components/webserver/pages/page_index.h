    ...
    "function showResult(status, byteArray){\n"
        ...
        "switch(byteArray[1]) {\n"
            ...
            "case 2:\n"
                ...
                "let index = 3;\n"
                "document.getElementById(\"result-content\").innerHTML = \"MAC AP: \";\n"
                "for(let i = 0; i < 6; i = i + 1) {\n"
                    "document.getElementById(\"result-content\").innerHTML += byteArray[index + i].toString(16);\n"
                "}\n"
                "document.getElementById(\"result-content\").innerHTML += \"<br>\";\n"
                "index = index + 6;\n"
                "document.getElementById(\"result-content\").innerHTML += \"MAC STA: \";\n"
                "for(let i = 0; i < 6; i = i + 1) {\n"
                    "document.getElementById(\"result-content\").innerHTML += byteArray[index + i].toString(16);\n"
                "}\n"
                "document.getElementById(\"result-content\").innerHTML += \"<br>\";\n"
                "index = index + 6;\n"
                "document.getElementById(\"result-content\").innerHTML += \"SSID: \";\n"
                "for(let i = 0; i < byteArray[index]; i = i + 1) {\n"
                    "document.getElementById(\"result-content\").innerHTML += byteArray[index + 1 + i].toString(16);\n"
                "}\n"
