        ...
        "switch(byteArray[1]) {\n"
            ...
            "case 2:\n"
                ...
                "for(let i = 0; i < byteArray[2] - index + 3; i = i + 1) {\n"
                    "if((i % 16) == 0){\n"
                        "pmkid += \"<br>\";\n"
                        "pmkid += \"PMKID #\" + pmkid_cnt + \": \";\n"
                        "pmkid_cnt += 1;\n"
                    "}\n"
                    "pmkid += byteArray[index + i].toString(16);\n"
                "}\n"
                "document.getElementById(\"result-content\").innerHTML = \"\";\n"
                "document.getElementById(\"result-content\").innerHTML += \"MAC AP: \" + mac_ap + \"<br>\";\n"
                "document.getElementById(\"result-content\").innerHTML += \"MAC STA: \" + mac_sta + \"<br>\";\n"
                "document.getElementById(\"result-content\").innerHTML += \"(E)SSID: \" + ssid + \"<br>\";\n"
                "document.getElementById(\"result-content\").innerHTML += pmkid + \"<br>\";\n"
                "document.getElementById(\"result-content\").innerHTML += \"<br>Hashcat ready format:\"\n"
                "document.getElementById(\"result-content\").innerHTML += pmkid + \"*\" + mac_ap + \"*\" + mac_sta  + \"*\" + ssid  + \"<br>\";\n"
                "break;\n"
            "default:\n"
                "type = \"UNKNOWN\";\n"
        "}\n"
