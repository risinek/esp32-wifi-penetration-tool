...
"<body onLoad=\"getStatus()\">\n"
    ...
    "function getStatus() {\n"
        ...
        "oReq.onerror = function() {\n"
            "document.getElementById(\"errors\").innerHTML = \"ERROR: Request failed\";\n"
        "};\n"
    ...
    "function showResult(status, byteArray){\n"
        ...
        "switch(byteArray[1]) {\n"
            ...
            "case 2:\n"
                ...
                "document.getElementById(\"result-content\").innerHTML = \"PMKIDs:<br>\";\n"
                "for(let i = 0; i < byteArray[2]; i = i + 1) {\n"
                    "if((i % 16) == 0){\n"
                        "document.getElementById(\"result-content\").innerHTML += \"<br>\";\n"
                    "}\n"
                    "document.getElementById(\"result-content\").innerHTML += byteArray[3 + i].toString(16);\n"
                    "}\n"
                "break;\n"
            "default:\n"
                "type = \"UNKNOWN\";\n"
    ...
    "function runAttack() {\n"
        ...
        "poll = setInterval(getStatus, poll_interval);\n"
