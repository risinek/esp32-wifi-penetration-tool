 ...
 */
typedef enum {
  ATTACK_HANDSHAKE_METHOD_ROGUE_AP, ///< Method using rogue/duplicated AP
                                    ///< utilising native ESP-IDF behaviour only
  ATTACK_HANDSHAKE_METHOD_BROADCAST, ///< Method that takes advantage of WSL
                                     ///< Bypasser component that bypass
                                     ///< blocking mechanism in Wi-Fi Stack
                                     ///< Libraries
                                     /// to send raw 802.11 frames
  ATTACK_HANDSHAKE_METHOD_PASSIVE,   ///< Passive method that does not intervene
                                   ///< communication on network, just passively
 ...
 *
 * @param attack_config attack config with valid ap_record and attack method
 * chosen
 */
 ...
 *
 * This function stops everything that attack_handshake_start() started and
