 ...
 */
typedef enum {
  ATTACK_DOS_METHOD_ROGUE_AP,   ///< Method using rogue/duplicated AP utilising
                                ///< native ESP-IDF behaviour only
  ATTACK_DOS_METHOD_BROADCAST,  ///< Method that takes advantage of WSL Bypasser
                                ///< component that bypass blocking mechanism in
 ...
 *
 * This function stops everything that attack_dos_start() started and resets all
 * values to default state.
 */
